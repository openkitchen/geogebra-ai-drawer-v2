...
4. **Low-Impact Testing:** Aim for >30% code coverage for all modules
...
6. **Verify Coverage:** Run coverage reports using the project's chosen tools. For example, in a Python project, this might look like:
   ...
   ```
   Target: >30% coverage for new code. The specific tools and commands will vary by language and framework.
...
- [ ] All tests pass
- [ ] Code coverage meets requirements (>30%)
